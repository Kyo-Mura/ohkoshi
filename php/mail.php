...
$Referer_check_domain = "dis-export.com";
...
尚、10月23日（金）にzoomが初めてで接続が不安な方用にzoomお試し接続会を開催いたします。
こちらは10月23日の14：40分ごろにお試し接続会用のURLをメールでお送り致しますので、
時間内でしたらいつでも接続可能です。
当日前に接続を試してみて下さい。
...
──────────────────────
株式会社ディス・エクスポール　ジャポン
〒102-0072 東京都千代田区飯田橋　2-11-10　山田ラインビル３　4F　
TEL：03- 5212 - 3621 　FAX：03- 5212 - 3621
E-mail:contact@dis-export.com　（代表）
URL: http://www.dis-export.com/
──────────────────────
